...
interface HomeScreenProps {
    navigation: StackNavigationProp<RootStackParamsList, 'DetailItem'>;
}
export default function App({ navigation }: HomeScreenProps) {
                                ...
                                <View style={styles.card3}>
                                    ...
                                    <TouchableOpacity
                                        style={{
                                            ...
                                            borderRadius: 25,
                                            padding: 10, // Add padding to simulate the button appearance
                                        }}
                                        onPress={handlePress}
                                    >
    ...
    return (
        <Tab.Navigator
            ...
            // Add the following line to explicitly define the type
            // @ts-ignore
